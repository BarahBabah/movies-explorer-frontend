      ...
      <form className="profile__form">
        <div className="profile__form-container">
          <label className="profile__label">Имя
            <input type="text" className="profile__input" value={name} placeholder={name} onChange={e => handleNameChange(e.target.value)} />
          </label>
          <label className="profile__label">E-mail
            <input type="email" className="profile__input" value={email} placeholder={email} onChange={e => HandleEmailChange(e.target.value)} />
          </label>
        </div>
